...
public class ControladorServletJPA extends HttpServlet {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -4576380724896652606L;
	protected DAOAdministracioUsuarios dao;
	...
	private JSONObject deletePersona (HttpServletRequest request) {
		...
		salida.put ("result", dao.darDeBaja(id,"Persona"));
		return salida;
	}
	...
	private JSONObject deleteUsuario (HttpServletRequest request) {
		JSONObject salida = new JSONObject ();
		int id = Integer.parseInt (request.getParameter("id"));
		salida.put ("result",dao.darDeBaja(id,"Usuario"));
		return salida;
	}
	...
	private JSONObject deleteRol (HttpServletRequest request) {
		JSONObject salida = new JSONObject ();
		int id = Integer.parseInt (request.getParameter("id"));
		salida.put ("result",dao.darDeBaja(id,"Rol"));
		return salida;
	}
	...
	private JSONObject deletePermiso (HttpServletRequest request) {
		JSONObject salida = new JSONObject ();
		int id = Integer.parseInt (request.getParameter("id"));
		salida.put("result", dao.darDeBaja(id,"Permiso"));	
		return salida;
	}
	...
	private JSONObject assignRol (HttpServletRequest request) {
		...
		salida.put ("result", dao.asignarRolAUsuario(id_rol, id_usuario));
	...
	private JSONObject removeRol (HttpServletRequest request) {
		...
		salida.put ("id_usuario", id_usuario);
		salida.put ("id_rol", id_rol);
		salida.put ("result", dao.desasignarRolAUsuario(id_rol, id_usuario));		
		return salida;
	}	
	...
	private JSONObject getPermisosUsuario (HttpServletRequest request) {		
		...
		JSONArray permisos = dao.NombrePermisosDeUnUsuario(nombre_usuario);//NombreRolUsuario(nombre_usuario);
	...
	private JSONObject assignPermiso (HttpServletRequest request) {
		...
		salida.put ("result", dao.asignarPermisoARol(id_rol, id_permiso));
	...
	private JSONObject revokePermiso (HttpServletRequest request) {
		...
		salida.put ("id_rol", id_rol);
		salida.put ("id_permiso", id_permiso);
		salida.put ("result", dao.desasignarPermisoARol(id_permiso, id_rol));
